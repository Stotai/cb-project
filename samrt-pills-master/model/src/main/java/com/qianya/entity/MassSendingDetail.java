...
public class MassSendingDetail implements Serializable {
    private Integer massDetailId;
    ...
    public Integer getMassDetailId() {
        return massDetailId;
    }

    public void setMassDetailId(Integer massDetailId) {
        this.massDetailId = massDetailId;
    }
