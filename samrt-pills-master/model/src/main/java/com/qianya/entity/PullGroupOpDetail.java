...
public class PullGroupOpDetail implements Serializable {
    private Integer opDetailId;
    ...
    public Integer getOpDetailId() {
        return opDetailId;
    }

    public void setOpDetailId(Integer opDetailId) {
    ...
    public String getXcxSize() {
        return xcxSize;
    }

    public void setXcxSize(String xcxSize) {
        this.xcxSize = xcxSize == null ? null : xcxSize.trim();
    }
