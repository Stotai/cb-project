...
/**
 * @Author: wangxin
 * @CreateTime: 2023-05-15  18:34
 * @Description: 方案明细入参
 */
public class SchemeItemDtoIn implements Serializable {
    private static final long serialVersionUID = -8366292294353141058L;




    @ApiModelProperty(value = "消息类型(1:文本;2:图片;3:动图;4:视频;5:卡片消息;6:小程序;7:视频号;8:邀请入群;9:催入群;10:退群消息)")
    private Integer itemType;

    @ApiModelProperty(value = "消息内容")
    private String itemContent;

    @ApiModelProperty(value = "等待执行秒数")
