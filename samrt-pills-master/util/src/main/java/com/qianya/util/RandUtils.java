...
public class RandUtils {
  static String ZIMU="abcdefghijklmnopqrstABCDEFGHIJKLMNOPQRST";
  static String SHUZI="1234567890";
  ...
  public static String getRand(int max_length){
		StringBuffer sb=new StringBuffer();
		for (int i = 0; i < max_length; i++) {
			Random r=new Random();
			sb.append(ZIMU.charAt(r.nextInt(ZIMU.length()-1)));
		}
		return sb.toString();
	}
	public static Long getRandNum(int max_length){
		StringBuffer sb=new StringBuffer();
		for (int i = 0; i < max_length; i++) {
			Random r=new Random();
			sb.append(SHUZI.charAt(r.nextInt(SHUZI.length()-1)));
		}
